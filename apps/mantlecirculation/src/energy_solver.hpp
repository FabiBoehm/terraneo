...
class SUPGSolver : public EnergySolver< ScalarType >
{
  ...
  public:
    ...
    void snapshot_for_picard() override { Kokkos::deep_copy( T_backup_.grid_data(), T_.grid_data() ); }
...
class EVSolver : public EnergySolver< ScalarType >
{
  ...
  public:
    ...
    , T_prev_backup_( "ev_T_prev_backup", *domain_, ownership_mask_ )
    {
        ...
        kernels::common::set_constant( kappa_wedge_, prm_.physics_parameters.thermal_diffusivity_nondim );
