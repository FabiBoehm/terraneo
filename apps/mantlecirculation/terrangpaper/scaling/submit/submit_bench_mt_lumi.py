...
DEFAULT_SWEEP: list[tuple[int, list[int]]] = [
    ...
    (7,  [1, 2, 4, 8, 16, 32, 64, 128]),      # MT128   actual 4..256  (+g1,g2 probe)
    (8,  [2, 4, 8, 16, 32, 64, 128, 256, 512]),     # MT256   actual 16..1024  (+g2,g4 probe)
    (9,  [4, 8, 16, 32, 64, 128, 256, 512, 1024]),  # MT512   actual 32..2048 (+g4,g8 probe)
