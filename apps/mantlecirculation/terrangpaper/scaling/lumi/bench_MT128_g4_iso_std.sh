#!/bin/bash -l
#SBATCH --job-name=bench_MT128_g4_iso_std
#SBATCH --output=bench_MT128_g4_iso_std.o%j
#SBATCH --error=bench_MT128_g4_iso_std.e%j
...
echo "Cell: MT128_g4_iso_std  mesh=[2..7]  rad_level=6  lat_sdr=1  rad_sdr=1  subdomains=80  subdom/GCD=20  steps=10  fgmres=10  ev=50  n_gpus=4  nodes=1x4  partition=standard-g"
