#!/bin/bash -l
#SBATCH --job-name=bench_MT128_g32_iso_std
#SBATCH --output=bench_MT128_g32_iso_std.o%j
#SBATCH --error=bench_MT128_g32_iso_std.e%j
...
echo "Cell: MT128_g32_iso_std  mesh=[3..7]  rad_level=6  lat_sdr=2  rad_sdr=2  subdomains=640  subdom/GCD=20  steps=10  fgmres=10  ev=50  n_gpus=32  nodes=4x8  partition=standard-g"
