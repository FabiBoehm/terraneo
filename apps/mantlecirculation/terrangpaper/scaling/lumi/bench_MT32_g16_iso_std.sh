#!/bin/bash -l
#SBATCH --job-name=bench_MT32_g16_iso_std
#SBATCH --output=bench_MT32_g16_iso_std.o%j
#SBATCH --error=bench_MT32_g16_iso_std.e%j
...
echo "Cell: MT32_g16_iso_std  mesh=[2..5]  rad_level=4  lat_sdr=1  rad_sdr=1  subdomains=80  subdom/GCD=5  steps=10  fgmres=10  ev=50  n_gpus=16  nodes=2x8  partition=standard-g"
