#!/bin/bash -l
#SBATCH --job-name=bench_MT256_g1_iso_std
#SBATCH --output=bench_MT256_g1_iso_std.o%j
#SBATCH --error=bench_MT256_g1_iso_std.e%j
...
echo "Cell: MT256_g1_iso_std  mesh=[2..8]  rad_level=7  lat_sdr=0  rad_sdr=0  subdomains=10  subdom/GCD=10  steps=10  fgmres=10  ev=50  n_gpus=1  nodes=1x1  partition=standard-g"
