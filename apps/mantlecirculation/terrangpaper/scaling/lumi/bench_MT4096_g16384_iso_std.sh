#!/bin/bash -l
#SBATCH --job-name=bench_MT4096_g16384_iso_std
#SBATCH --output=bench_MT4096_g16384_iso_std.o%j
#SBATCH --error=bench_MT4096_g16384_iso_std.e%j
...
echo "Cell: MT4096_g16384_iso_std  mesh=[6..12]  rad_level=11  lat_sdr=5  rad_sdr=5  subdomains=327680  subdom/GCD=20  steps=10  fgmres=10  ev=50  n_gpus=16384  nodes=2048x8  partition=fmr-g"
