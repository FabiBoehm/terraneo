#!/bin/bash -l
#SBATCH --job-name=bench_MT64_g32_iso_lowmem
#SBATCH --output=bench_MT64_g32_iso_lowmem.o%j
#SBATCH --error=bench_MT64_g32_iso_lowmem.e%j
...
echo "Cell: MT64_g32_iso_lowmem  mesh=[3..6]  rad_level=5  lat_sdr=2  rad_sdr=2  subdomains=640  subdom/GCD=20  steps=10  fgmres=10  ev=50  n_gpus=32  nodes=4x8  partition=standard-g"
