#!/bin/bash -l
#SBATCH --job-name=bench_MT512_g1024_iso_lowmem
#SBATCH --output=bench_MT512_g1024_iso_lowmem.o%j
#SBATCH --error=bench_MT512_g1024_iso_lowmem.e%j
...
echo "Cell: MT512_g1024_iso_lowmem  mesh=[4..9]  rad_level=8  lat_sdr=3  rad_sdr=3  subdomains=5120  subdom/GCD=5  steps=10  fgmres=10  ev=50  n_gpus=1024  nodes=128x8  partition=standard-g"
