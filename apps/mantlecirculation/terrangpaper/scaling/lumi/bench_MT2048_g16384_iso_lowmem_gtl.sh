#!/bin/bash -l
#SBATCH --job-name=bench_MT2048_g16384_iso_lowmem_gtl
#SBATCH --output=bench_MT2048_g16384_iso_lowmem_gtl.o%j
#SBATCH --error=bench_MT2048_g16384_iso_lowmem_gtl.e%j
#SBATCH -D /pfs/lustrep3/users/bohmfabi/terraneo/apps/mantlecirculation/bench_mt/jobs
#SBATCH --partition=fmr-g
#SBATCH --reservation=LUMIG_FMR_JUNE26
...
echo "Cell: MT2048_g16384_iso_lowmem_gtl  mesh=[6..11]  rad_level=10  lat_sdr=5  rad_sdr=5  subdomains=327680  subdom/GCD=20  steps=10  fgmres=10  ev=50  n_gpus=16384  nodes=2048x8  partition=fmr-g"
...
export GTL_DREG_CACHE_SIZE=524288
ulimit -c 0
