#!/bin/bash -l
#SBATCH --job-name=bench_MT32_g2_iso_std
#SBATCH --output=bench_MT32_g2_iso_std.o%j
#SBATCH --error=bench_MT32_g2_iso_std.e%j
...
echo "Cell: MT32_g2_iso_std  mesh=[2..5]  rad_level=4  lat_sdr=0  rad_sdr=0  subdomains=10  subdom/GCD=5  steps=10  fgmres=10  ev=50  n_gpus=2  nodes=1x2  partition=standard-g"
