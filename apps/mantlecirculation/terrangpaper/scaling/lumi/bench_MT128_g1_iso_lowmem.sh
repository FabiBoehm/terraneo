#!/bin/bash -l
#SBATCH --job-name=bench_MT128_g1_iso_lowmem
#SBATCH --output=bench_MT128_g1_iso_lowmem.o%j
#SBATCH --error=bench_MT128_g1_iso_lowmem.e%j
...
echo "Cell: MT128_g1_iso_lowmem  mesh=[2..7]  rad_level=6  lat_sdr=0  rad_sdr=0  subdomains=10  subdom/GCD=10  steps=10  fgmres=10  ev=50  n_gpus=1  nodes=1x1  partition=standard-g"
