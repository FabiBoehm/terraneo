#!/bin/bash -l
#SBATCH --job-name=bench_MT512_g256_iso_std
#SBATCH --output=bench_MT512_g256_iso_std.o%j
#SBATCH --error=bench_MT512_g256_iso_std.e%j
...
echo "Cell: MT512_g256_iso_std  mesh=[4..9]  rad_level=8  lat_sdr=3  rad_sdr=3  subdomains=5120  subdom/GCD=20  steps=10  fgmres=10  ev=50  n_gpus=256  nodes=32x8  partition=standard-g"
