#!/bin/bash -l
#SBATCH --job-name=bench_MT256_g16_iso_lowmem
#SBATCH --output=bench_MT256_g16_iso_lowmem.o%j
#SBATCH --error=bench_MT256_g16_iso_lowmem.e%j
...
echo "Cell: MT256_g16_iso_lowmem  mesh=[2..8]  rad_level=7  lat_sdr=1  rad_sdr=1  subdomains=80  subdom/GCD=5  steps=10  fgmres=10  ev=50  n_gpus=16  nodes=2x8  partition=standard-g"
