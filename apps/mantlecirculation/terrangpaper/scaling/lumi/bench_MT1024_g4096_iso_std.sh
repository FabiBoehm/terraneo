#!/bin/bash -l
#SBATCH --job-name=bench_MT1024_g4096_iso_std
#SBATCH --output=bench_MT1024_g4096_iso_std.o%j
#SBATCH --error=bench_MT1024_g4096_iso_std.e%j
...
echo "Cell: MT1024_g4096_iso_std  mesh=[5..10]  rad_level=9  lat_sdr=4  rad_sdr=4  subdomains=40960  subdom/GCD=10  steps=10  fgmres=10  ev=50  n_gpus=4096  nodes=512x8  partition=standard-g"
