#!/bin/bash -l
#SBATCH --job-name=bench_MT4096_g8192_iso_lowmem
#SBATCH --output=bench_MT4096_g8192_iso_lowmem.o%j
#SBATCH --error=bench_MT4096_g8192_iso_lowmem.e%j
...
echo "Cell: MT4096_g8192_iso_lowmem  mesh=[5..12]  rad_level=11  lat_sdr=4  rad_sdr=4  subdomains=40960  subdom/GCD=5  steps=10  fgmres=10  ev=50  n_gpus=8192  nodes=1024x8  partition=standard-g"
