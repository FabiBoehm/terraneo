#!/bin/bash -l
#SBATCH --job-name=bench_MT512_g2048_iso_lowmem
#SBATCH --output=bench_MT512_g2048_iso_lowmem.o%j
#SBATCH --error=bench_MT512_g2048_iso_lowmem.e%j
...
echo "Cell: MT512_g2048_iso_lowmem  mesh=[5..9]  rad_level=8  lat_sdr=4  rad_sdr=4  subdomains=40960  subdom/GCD=20  steps=10  fgmres=10  ev=50  n_gpus=2048  nodes=256x8  partition=standard-g"
