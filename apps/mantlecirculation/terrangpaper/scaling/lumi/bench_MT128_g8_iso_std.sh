#!/bin/bash -l
#SBATCH --job-name=bench_MT128_g8_iso_std
#SBATCH --output=bench_MT128_g8_iso_std.o%j
#SBATCH --error=bench_MT128_g8_iso_std.e%j
...
echo "Cell: MT128_g8_iso_std  mesh=[2..7]  rad_level=6  lat_sdr=1  rad_sdr=1  subdomains=80  subdom/GCD=10  steps=10  fgmres=10  ev=50  n_gpus=8  nodes=1x8  partition=standard-g"
