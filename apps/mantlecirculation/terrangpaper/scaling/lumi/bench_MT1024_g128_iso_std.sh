#!/bin/bash -l
#SBATCH --job-name=bench_MT1024_g128_iso_std
#SBATCH --output=bench_MT1024_g128_iso_std.o%j
#SBATCH --error=bench_MT1024_g128_iso_std.e%j
...
echo "Cell: MT1024_g128_iso_std  mesh=[3..10]  rad_level=9  lat_sdr=2  rad_sdr=2  subdomains=640  subdom/GCD=5  steps=10  fgmres=10  ev=50  n_gpus=128  nodes=16x8  partition=standard-g"
