#!/bin/bash -l
#SBATCH --job-name=bench_MT512_g128_iso_lowmem
#SBATCH --output=bench_MT512_g128_iso_lowmem.o%j
#SBATCH --error=bench_MT512_g128_iso_lowmem.e%j
...
echo "Cell: MT512_g128_iso_lowmem  mesh=[3..9]  rad_level=8  lat_sdr=2  rad_sdr=2  subdomains=640  subdom/GCD=5  steps=10  fgmres=10  ev=50  n_gpus=128  nodes=16x8  partition=standard-g"
