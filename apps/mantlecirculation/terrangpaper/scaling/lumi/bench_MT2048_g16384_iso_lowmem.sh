#!/bin/bash -l
#SBATCH --job-name=bench_MT2048_g16384_iso_lowmem
#SBATCH --output=bench_MT2048_g16384_iso_lowmem.o%j
#SBATCH --error=bench_MT2048_g16384_iso_lowmem.e%j
...
echo "Cell: MT2048_g16384_iso_lowmem  mesh=[6..11]  rad_level=10  lat_sdr=5  rad_sdr=5  subdomains=327680  subdom/GCD=20  steps=10  fgmres=10  ev=50  n_gpus=16384  nodes=2048x8  partition=fmr-g"
