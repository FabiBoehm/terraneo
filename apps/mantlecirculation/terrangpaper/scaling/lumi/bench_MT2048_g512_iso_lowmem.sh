#!/bin/bash -l
#SBATCH --job-name=bench_MT2048_g512_iso_lowmem
#SBATCH --output=bench_MT2048_g512_iso_lowmem.o%j
#SBATCH --error=bench_MT2048_g512_iso_lowmem.e%j
...
echo "Cell: MT2048_g512_iso_lowmem  mesh=[4..11]  rad_level=10  lat_sdr=3  rad_sdr=3  subdomains=5120  subdom/GCD=10  steps=10  fgmres=10  ev=50  n_gpus=512  nodes=64x8  partition=standard-g"
