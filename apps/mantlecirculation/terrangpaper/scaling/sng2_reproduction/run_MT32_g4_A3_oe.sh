#!/bin/bash -l
#SBATCH --job-name=oe_MT32_g4_A3_oe
#SBATCH --output=/hppfs/scratch/0E/di35guv2/mc_runs/scal_jobs_origenv/MT32_g4_A3_oe.o%j
#SBATCH --error=/hppfs/scratch/0E/di35guv2/mc_runs/scal_jobs_origenv/MT32_g4_A3_oe.e%j
...
mkdir -p "$TMPDIR" "/hppfs/scratch/0E/di35guv2/scal_a3_origenv/MT32_g4_A3_oe"
cd "/hppfs/scratch/0E/di35guv2/scal_a3_origenv/MT32_g4_A3_oe"
srun --chdir="/hppfs/scratch/0E/di35guv2/scal_a3_origenv/MT32_g4_A3_oe" "/hppfs/scratch/0E/di35guv2/terraneo-merged-build/apps/mantlecirculation/mantlecirculation" --config "/hppfs/scratch/0E/di35guv2/mc_runs/merged_configs/config_scal_A3.toml" --extended-parameters \
  --energy-solver ev \
  ...
  --outdir "/hppfs/scratch/0E/di35guv2/scal_a3_origenv/MT32_g4_A3_oe" --outdir-overwrite
