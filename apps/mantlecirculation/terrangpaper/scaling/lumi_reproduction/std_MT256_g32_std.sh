#!/bin/bash -l
#SBATCH --job-name=ls_MT256_g32_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT256_g32_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT256_g32_std.e%j
...
echo "Cell: MT256_g32_std  mesh=[2..8]  lat_sdr=2 rad_sdr=0  steps=10  fgmres=10  ev=50  n_gcds=32  nodes=4x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/MT256_g32_std}"
