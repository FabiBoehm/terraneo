#!/bin/bash -l
#SBATCH --job-name=ls_MT512_g128_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT512_g128_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT512_g128_std.e%j
...
echo "Cell: MT512_g128_std  mesh=[3..9]  lat_sdr=3 rad_sdr=0  steps=10  fgmres=10  ev=50  n_gcds=128  nodes=16x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/MT512_g128_std}"
