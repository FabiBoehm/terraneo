#!/bin/bash -l
#SBATCH --job-name=ls_MT512_g512_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT512_g512_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT512_g512_std.e%j
...
echo "Cell: MT512_g512_std  mesh=[4..9]  lat_sdr=4 rad_sdr=0  steps=10  fgmres=10  ev=50  n_gcds=512  nodes=64x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/MT512_g512_std}"
...
srun --cpu-bind=map_cpu:49,57,17,25,1,9,33,41 ${SELECT_GPU} "$BIN" --config "$CFG" --extended-parameters \
  ...
  --lat-sdr 4 --rad-sdr 0 --radial-extra-levels -1 \
