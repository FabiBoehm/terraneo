#!/bin/bash -l
#SBATCH --job-name=lr_MT4096_g8192_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT4096_g8192_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT4096_g8192_std.e%j
...
echo "Cell: MT4096_g8192_std  mesh=[5..12]  subdomains-level=4  steps=10  fgmres=10  ev=50  n_gcds=8192  nodes=1024x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT4096_g8192_std}"
