#!/bin/bash -l
#SBATCH --job-name=lr_MT1024_g64_lowmem
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT1024_g64_lowmem.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT1024_g64_lowmem.e%j
...
echo "Cell: MT1024_g64_lowmem  mesh=[3..10]  subdomains-level=2  steps=10  fgmres=10  ev=50  n_gcds=64  nodes=8x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT1024_g64_lowmem}"
