#!/bin/bash -l
#SBATCH --job-name=ls_MT512_g64_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT512_g64_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT512_g64_std.e%j
...
echo "Cell: MT512_g64_std  mesh=[2..9]  lat_sdr=2 rad_sdr=1  steps=10  fgmres=10  ev=50  n_gcds=64  nodes=8x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/MT512_g64_std}"
...
srun --cpu-bind=map_cpu:49,57,17,25,1,9,33,41 ${SELECT_GPU} "$BIN" --config "$CFG" --extended-parameters \
  ...
  --refinement-level-mesh-min 2 --refinement-level-mesh-max 9 \
  --lat-sdr 2 --rad-sdr 1 --radial-extra-levels -1 \
