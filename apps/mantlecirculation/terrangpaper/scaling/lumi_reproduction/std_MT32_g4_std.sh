#!/bin/bash -l
#SBATCH --job-name=ls_MT32_g4_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT32_g4_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT32_g4_std.e%j
...
echo "Cell: MT32_g4_std  mesh=[2..5]  lat_sdr=0 rad_sdr=1  steps=10  fgmres=10  ev=50  n_gcds=4  nodes=1x4"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/MT32_g4_std}"
