#!/bin/bash -l
#SBATCH --job-name=ls_MT1024_g1024_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT1024_g1024_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT1024_g1024_std.e%j
...
echo "Cell: MT1024_g1024_std  mesh=[4..10]  lat_sdr=4 rad_sdr=1  steps=10  fgmres=10  ev=50  n_gcds=1024  nodes=128x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/MT1024_g1024_std}"
