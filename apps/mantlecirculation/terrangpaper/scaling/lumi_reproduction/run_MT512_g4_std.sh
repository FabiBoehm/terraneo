#!/bin/bash -l
#SBATCH --job-name=lr_MT512_g4_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT512_g4_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT512_g4_std.e%j
...
echo "Cell: MT512_g4_std  mesh=[2..9]  subdomains-level=1  steps=10  fgmres=10  ev=50  n_gcds=4  nodes=1x4"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT512_g4_std}"
