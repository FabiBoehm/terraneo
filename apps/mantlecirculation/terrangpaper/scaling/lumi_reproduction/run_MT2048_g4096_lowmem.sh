#!/bin/bash -l
#SBATCH --job-name=lr_MT2048_g4096_lowmem
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT2048_g4096_lowmem.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT2048_g4096_lowmem.e%j
...
echo "Cell: MT2048_g4096_lowmem  mesh=[5..11]  subdomains-level=4  steps=10  fgmres=10  ev=50  n_gcds=4096  nodes=512x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT2048_g4096_lowmem}"
