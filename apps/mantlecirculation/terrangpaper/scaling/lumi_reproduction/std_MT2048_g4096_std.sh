#!/bin/bash -l
#SBATCH --job-name=ls_MT2048_g4096_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT2048_g4096_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT2048_g4096_std.e%j
...
echo "Cell: MT2048_g4096_std  mesh=[5..11]  lat_sdr=5 rad_sdr=1  steps=10  fgmres=10  ev=50  n_gcds=4096  nodes=512x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/MT2048_g4096_std}"
...
srun --cpu-bind=map_cpu:49,57,17,25,1,9,33,41 ${SELECT_GPU} "$BIN" --config "$CFG" --extended-parameters \
  ...
  --lat-sdr 5 --rad-sdr 1 --radial-extra-levels -1 \
