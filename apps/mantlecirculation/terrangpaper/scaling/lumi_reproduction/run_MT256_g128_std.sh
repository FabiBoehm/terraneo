#!/bin/bash -l
#SBATCH --job-name=lr_MT256_g128_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT256_g128_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT256_g128_std.e%j
...
echo "Cell: MT256_g128_std  mesh=[3..8]  subdomains-level=2  steps=10  fgmres=10  ev=50  n_gcds=128  nodes=16x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT256_g128_std}"
