#!/bin/bash -l
#SBATCH --job-name=lr_MT128_g2_lowmem
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT128_g2_lowmem.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT128_g2_lowmem.e%j
...
echo "Cell: MT128_g2_lowmem  mesh=[2..7]  subdomains-level=0  steps=10  fgmres=10  ev=50  n_gcds=2  nodes=1x2"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT128_g2_lowmem}"
