#!/bin/bash -l
#SBATCH --job-name=lr_MT512_g2048_lowmem
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT512_g2048_lowmem.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT512_g2048_lowmem.e%j
...
echo "Cell: MT512_g2048_lowmem  mesh=[5..9]  subdomains-level=4  steps=10  fgmres=10  ev=50  n_gcds=2048  nodes=256x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT512_g2048_lowmem}"
