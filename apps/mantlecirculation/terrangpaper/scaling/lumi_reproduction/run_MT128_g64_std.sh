#!/bin/bash -l
#SBATCH --job-name=lr_MT128_g64_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT128_g64_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT128_g64_std.e%j
...
echo "Cell: MT128_g64_std  mesh=[3..7]  subdomains-level=2  steps=10  fgmres=10  ev=50  n_gcds=64  nodes=8x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT128_g64_std}"
