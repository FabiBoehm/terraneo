#!/bin/bash -l
#SBATCH --job-name=lr_MT256_g1024_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT256_g1024_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT256_g1024_std.e%j
...
echo "Cell: MT256_g1024_std  mesh=[4..8]  subdomains-level=3  steps=10  fgmres=10  ev=50  n_gcds=1024  nodes=128x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT256_g1024_std}"
