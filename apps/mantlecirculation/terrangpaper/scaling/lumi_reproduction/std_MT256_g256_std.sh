#!/bin/bash -l
#SBATCH --job-name=ls_MT256_g256_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT256_g256_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT256_g256_std.e%j
...
echo "Cell: MT256_g256_std  mesh=[3..8]  lat_sdr=3 rad_sdr=1  steps=10  fgmres=10  ev=50  n_gcds=256  nodes=32x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/MT256_g256_std}"
