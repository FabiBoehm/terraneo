#!/bin/bash -l
#SBATCH --job-name=lr_MT256_g256_lowmem
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT256_g256_lowmem.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT256_g256_lowmem.e%j
...
echo "Cell: MT256_g256_lowmem  mesh=[4..8]  subdomains-level=3  steps=10  fgmres=10  ev=50  n_gcds=256  nodes=32x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT256_g256_lowmem}"
