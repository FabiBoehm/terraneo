#!/bin/bash -l
#SBATCH --job-name=lr_MT64_g8_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT64_g8_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT64_g8_std.e%j
...
echo "Cell: MT64_g8_std  mesh=[2..6]  subdomains-level=1  steps=10  fgmres=10  ev=50  n_gcds=8  nodes=1x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT64_g8_std}"
