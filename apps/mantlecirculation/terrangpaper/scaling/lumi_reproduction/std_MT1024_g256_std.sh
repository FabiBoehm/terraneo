...
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT1024_g256_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT1024_g256_std.e%j
...
echo "Cell: MT1024_g256_std  mesh=[3..10]  lat_sdr=3 rad_sdr=1  steps=10  fgmres=10  ev=50  n_gcds=256  nodes=32x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/MT1024_g256_std}"
...
srun --cpu-bind=map_cpu:49,57,17,25,1,9,33,41 ${SELECT_GPU} "$BIN" --config "$CFG" --extended-parameters \
  ...
  --refinement-level-mesh-min 3 --refinement-level-mesh-max 10 \
  --lat-sdr 3 --rad-sdr 1 --radial-extra-levels -1 \
