#!/bin/bash -l
#SBATCH --job-name=lr_MT64_g32_lowmem
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT64_g32_lowmem.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT64_g32_lowmem.e%j
...
echo "Cell: MT64_g32_lowmem  mesh=[3..6]  subdomains-level=2  steps=10  fgmres=10  ev=50  n_gcds=32  nodes=4x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT64_g32_lowmem}"
