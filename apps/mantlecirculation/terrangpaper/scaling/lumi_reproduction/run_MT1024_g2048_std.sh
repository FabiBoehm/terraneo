#!/bin/bash -l
#SBATCH --job-name=lr_MT1024_g2048_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT1024_g2048_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT1024_g2048_std.e%j
...
echo "Cell: MT1024_g2048_std  mesh=[5..10]  subdomains-level=4  steps=10  fgmres=10  ev=50  n_gcds=2048  nodes=256x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT1024_g2048_std}"
