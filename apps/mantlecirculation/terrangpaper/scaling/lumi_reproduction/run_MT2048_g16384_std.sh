#!/bin/bash -l
#SBATCH --job-name=lr_MT2048_g16384_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT2048_g16384_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT2048_g16384_std.e%j
...
echo "Cell: MT2048_g16384_std  mesh=[6..11]  subdomains-level=5  steps=10  fgmres=10  ev=50  n_gcds=16384  nodes=2048x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT2048_g16384_std}"
