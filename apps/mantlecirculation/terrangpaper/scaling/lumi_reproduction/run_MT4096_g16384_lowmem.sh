#!/bin/bash -l
#SBATCH --job-name=lr_MT4096_g16384_lowmem
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT4096_g16384_lowmem.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT4096_g16384_lowmem.e%j
...
echo "Cell: MT4096_g16384_lowmem  mesh=[6..12]  subdomains-level=5  steps=10  fgmres=10  ev=50  n_gcds=16384  nodes=2048x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT4096_g16384_lowmem}"
...
srun --cpu-bind=map_cpu:49,57,17,25,1,9,33,41 ${SELECT_GPU} "$BIN" --config "$CFG" --extended-parameters \
  ...
  --refinement-level-mesh-min 6 --refinement-level-mesh-max 12 \
  --refinement-level-subdomains 5 --radial-extra-levels -1 \
