#!/bin/bash -l
#SBATCH --job-name=lr_MT512_g512_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT512_g512_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi/logs/MT512_g512_std.e%j
...
echo "Cell: MT512_g512_std  mesh=[4..9]  subdomains-level=3  steps=10  fgmres=10  ev=50  n_gcds=512  nodes=64x8"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi/MT512_g512_std}"
