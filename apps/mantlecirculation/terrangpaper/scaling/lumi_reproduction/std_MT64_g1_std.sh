#!/bin/bash -l
#SBATCH --job-name=ls_MT64_g1_std
#SBATCH --output=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT64_g1_std.o%j
#SBATCH --error=/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/logs/MT64_g1_std.e%j
...
echo "Cell: MT64_g1_std  mesh=[2..6]  lat_sdr=0 rad_sdr=0  steps=10  fgmres=10  ev=50  n_gcds=1  nodes=1x1"
...
OUT="${TERRANG_OUT:-/scratch/project_465002367/bohmfabi/scal_a3_lumi_std/MT64_g1_std}"
...
srun --cpu-bind=map_cpu:49 ${SELECT_GPU} "$BIN" --config "$CFG" --extended-parameters \
  --energy-solver ev \
