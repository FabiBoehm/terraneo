#!/bin/bash -l
#SBATCH --job-name=snb_MT64_g2
#SBATCH --output=/hppfs/scratch/0E/di35guv2/bench_mt/jobs/snb_MT64_g2.o%j
#SBATCH --error=/hppfs/scratch/0E/di35guv2/bench_mt/jobs/snb_MT64_g2.e%j
